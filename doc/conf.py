# -*- coding: utf-8 -*-
#
# Discodex documentation build configuration file, created by
...
version = '%DISCODEX_VERSION%'
# The full version, including alpha/beta/rc tags.
release = '%DISCODEX_RELEASE%'
...
latex_documents = [
  ('index', 'Discodex.tex', 'Discodex Documentation', 'Disco Project', 'manual'),
]
